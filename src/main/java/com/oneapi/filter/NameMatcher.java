...
public class NameMatcher implements Filter {
    ...
    public NameMatcher(InstanceJpaRepository instanceRepo) {
        this(instanceRepo, true);
    }

    public NameMatcher(InstanceJpaRepository instanceRepo, boolean requireVirtualModel) {
    ...
    public RelayContext apply(RelayContext ctx) {
        ...
        if (instanceRepo.existsByModelNameAndStatusIn(model,
                java.util.List.of(com.oneapi.model.Instance.STATUS_RAW, com.oneapi.model.Instance.STATUS_TAGGED))) {
